...
class GameController extends \UserFrosting\BaseController {
    ...
    public function getGameScheduleAPI(){
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_URL => 'http://www.fantasyfootballnerd.com/service/schedule/json/2r3z3pvzqrpi/',            
            CURLOPT_POST => 1            
        ));
    ...
    public function getGameTeamsAPI(){
        ...
        curl_setopt_array($curl, array(
            CURLOPT_RETURNTRANSFER => 1,
            CURLOPT_URL => 'http://www.fantasyfootballnerd.com/service/nfl-teams/json/2r3z3pvzqrpi/',            
            CURLOPT_POST => 1            
        ));
        // Send the request & save response to $resp
        $resp = curl_exec($curl);
