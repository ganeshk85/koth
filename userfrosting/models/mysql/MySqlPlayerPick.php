...
class MySqlPlayerPick extends MySqlDatabaseObject {
    ...
    public function getPastPlayerPicks($current_week, $player_ids){
        ...
        foreach($player_ids as $player)
        {
            ...
            $query = "
            SELECT $player_pick_table.id, $player_table.id, $player_table.player_name, $player_table.user_name, $player_table.primary_user_id, $player_table.active, $player_table.enabled, $player_table.lost, $teams_table.full_name, $player_pick_table.week_id, $player_pick_table.picked_time_stamp
